...
learn some simple broadcasting, and output their results to files or plots.
...
=item L<PDL::Book::Broadcasting> Broadcasting and Getting rid of FOR loops
...
=item Demonstrating broadcasting with the Game of Life
