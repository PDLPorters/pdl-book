...
repository at:
    ...
    http://sourceforge.net/p/pdl/pdl-book/ci/master/tree/00README.pod

To get a local copy on your computer, use:

    git clone http://git.code.sf.net/p/pdl/pdl-book pdl-pdl-book
...
things, clone this URL:
    ...
    git clone ssh://USERNAME@git.code.sf.net/p/pdl/pdl-book pdl-pdl-book
