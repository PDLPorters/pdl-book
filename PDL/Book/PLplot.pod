...
B<PDL::Graphics::PLplot::Cookbook>
...
=head1 Introducing C<PDL::Graphics::PLplot>
...
=head1 Credits
   ...
   David Merten's slideshow on B<PDL::Graphics-PLplot>.
   His very informative slideshow can be downloaded or viewed at L<http://www.slideshare.net/dcmertens/p-lplot-talk>  
