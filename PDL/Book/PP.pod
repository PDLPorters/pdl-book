...
invoked directly by you, the coder, at run time -- it is invoked by
make(1) as part of module compilation under the control of MakeMaker,
or by Inline::PP as part of inline compilation of snippets of PP.

After reading this introduction, you should have a firm grasp on the
basics of using PDL::PP and the full documentation in the PDL::PP man
page should be fairly easy to follow.
