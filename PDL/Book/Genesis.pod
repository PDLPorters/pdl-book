...
involves a lot of analysis of digital data accumualated on many nights
...
spectral revealing the secrets of the composition and propertues of
...
expressions.  In fact some commericial software worked like this, and I
...
We've all been there. You know how you want to analyse your data. You
need to Fourier transform it, take the square root, multiply by a
high-pass filter and sum up all the high frequence modes. But it's two
...
able to pull together seperate subroutine libraries to do file
...
note are commericial software such as C<IDL> ('Image Data Language' from
...
Athough much of the code is indeed free/public domain money is made out
...
easily customisable. Well in our view one of the reasons this has not
...
across many instititutes and nations. The only way to ensure that all
...
anti-commericial, these packages are very powerful and useful. However
...
really 'compelling rationalisations'!)
...
features by their propritary nature and specialist syntax. We think it
...
results and which grows with the user. We recognise of course that much
of this is just a matter of preference. NumPy snd SciPy have grown into
