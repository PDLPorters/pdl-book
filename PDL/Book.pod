...
=item L<PDL::Book::Broadcasting> (NOT YET) Broadcasting and Getting rid of FOR loops
...
The power of PDL is in the ability to carry out broadcasting
over N-dimensional PDLs. When you code with
broadcasting you eliminate the multiple FOR loops that are the source of
many slow-downs in code. Reading Broadcasting and Functions will get you up
